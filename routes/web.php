...
Route::group(['middleware' => ['maintainance']], function () {
    ...
    Route::post('/store-registers', [RegisterController::class, 'storeRegister'])->name('store-register');
    ...
    Route::group(['as'=> 'user.', 'prefix' => 'user'],function (){
        ...
        Route::get('trade', [UserProfileController::class, 'trade'])->name('trade');
        Route::post('trade_add', [UserProfileController::class, 'trade_add'])->name('trade_add');
...
Route::group(['as'=> 'admin.', 'prefix' => 'admin'],function (){
    ...
    Route::get('create_asset', [AssetController::class,'create'])->name('create_asset');
    Route::post('store_asset', [AssetController::class,'store'])->name('store_asset');
    Route::put('asset-status/{id}', [AssetController::class,'changeStatus'])->name('asset-status');
